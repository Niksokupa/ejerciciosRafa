...
public class Control extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!request.getParameter("segundo").matches("^[0-9][0-9]*$") && !request.getParameter("segundo").equals("")) {
			lineaerrores = new ArrayList<String>();
			lineaerrores.add("Error: Introduce caracteres numericos o positivos en segundo");
			errores.add(lineaerrores);
		}
		if (!request.getParameter("primero").matches("^[0-9][0-9]*$") && !request.getParameter("primero").equals("")) {
			lineaerrores = new ArrayList<String>();
			lineaerrores.add("Error: Introduce caracteres numericos o positivos en primero");
			errores.add(lineaerrores);
		}
